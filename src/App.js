  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route
          path="/inprogressorder/:orderNo3"
          element={<ProgressOrderdetails />}
        />
        <Route
          path="/RegisteredPerson/:registerdid"
        ...
        <Route
          ...
          element={<ApplicantPerson />}
        />
        <Route path="/adminprofile" element={<Adminprofile />} />
        <Route
          path="/adminform/:adminid1"
          element={<Administratorsdetails />}
        />
        <Route path="/verifypicked" element={<Verifypicked />} />
        <Route
          path="/verifypickedorder/:orderNo4"
          element={<VerifypickedDetails />}
        />
        <Route path="/verifydilivery" element={<Verifydilivery />} />
        <Route
          path="/verifydiliveryorder/:orderNo5"
          element={<VerifydiliveryDetails />}
        />
        <Route path="/createbranch" element={<Createbranch />} />
        <Route
          path="/orderdelails/:orderId"
          element={<DetailsOrderTracker />}
        />
        <Route
        ...
        <Route path="/adminApplicant/:admin_Id" element={<AdminPersonDetails />} />
      </Routes>
    </BrowserRouter>
  );
}
